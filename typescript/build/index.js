...
let skillContainer = document.getElementById("skill_container");
...
window.addEventListener("load", () => {
    ...
    for (let x = 0; x < skillArray.length; x++) {
        skillContainer.innerHTML += `
            ...
            `;
        let loading = document.getElementsByClassName(`skillCircle`);
...
function workFunc(index) {
    ...
    let workCount = document.getElementById("work_index");
